...
In animal pose estimation, most frameworks make it very easy to do a slight variant of this. Instead of fixed folds, people often do random samples for the training and the test set (in DLC these are called "shuffles").
...
::: {.column .nonincremental style="width: 35%; text-align: left; margin-top: 5%"}
...
::: {.column style="width: 60%; margin-left: 4%; margin-top: 0%"}

::: {.r-stack}
::: {.fragment .fade-out data-fragment-index="1"}
![](../img/training/training-one-sample.png){width=100% style="border: 1px solid black;"}
:::

::: {.fragment .fade-in data-fragment-index="1"}
::: {.fragment .fade-out data-fragment-index="3"}
![](../img/training/loss-intro.png){width=100% style="border: 1px solid black;"}
:::
:::

::: {.fragment .fade-in data-fragment-index="3"}
![](../img/training/gd-intro.png){width=100% style="border: 1px solid black;"}
:::
...
<div style="text-align: left; margin-left: -10%; margin-top: -35%;">
<div style="font-weight: bold; font-size: 22px; margin-bottom: 0px; margin-left: 45px;">Raw scores</div>
<div style="font-family: 'Courier New', monospace; font-size: 17px; line-height: 1.9; margin-top: 10px; margin-left: 50px;">
...
::: {.column style="width: 10%; margin-top: 20%"}
...
We would like the score for the correct class, in this case “3”, to be very high, and 
...
interpretability if these scores would actually represent a probability distribution
...
real numbers and normalices them into a prob distribution (in which each prob is
proportional to the exp of the score). So after the softmax each score will be now between 0 
