...
digraph G {
    ...
    //   bias [shape=square, label="b₀¹", width=0.06, height=0.06, fillcolor="#D51818"];
    //   {rank=same; h2_prime; bias;}
    // }


    h1 -> h1_prime;
    h1 -> h2_prime [color="#89E141", penwidth=2.0];
    h1 -> h3_prime;
    h1 -> h4_prime;
    h1 -> h5_prime;

    h2 -> h1_prime;
    h2 -> h2_prime [color="#89E141", penwidth=2.0];
    h2 -> h3_prime;
    h2 -> h4_prime;
    h2 -> h5_prime;

    h3 -> h1_prime;
    h3 -> h2_prime [color="#89E141", penwidth=2.0];
    h3 -> h3_prime;
    h3 -> h4_prime;
    h3 -> h5_prime;

    h4 -> h1_prime;
    h4 -> h2_prime [color="#89E141", penwidth=2.0];
    h4 -> h3_prime;
    h4 -> h4_prime;
    h4 -> h5_prime;

    h5 -> h1_prime;
    h5 -> h2_prime [color="#89E141", penwidth=2.0];
    h5 -> h3_prime;
    h5 -> h4_prime;
    h5 -> h5_prime;

    h6 -> h1_prime;
    h6 -> h2_prime [color="#89E141", penwidth=2.0];
    h6 -> h3_prime;
    h6 -> h4_prime;
    h6 -> h5_prime;

    // bias -> h2_prime [color="#D51818", penwidth=2.0, style="dashed", arrowhead="none"];
...
digraph G {
    ...
    h1 -> h3_prime;
    h1 -> h4_prime;
    h1 -> h5_prime [color="#89E141", penwidth=2.0];

    h2 -> h1_prime;
    h2 -> h2_prime;
    h2 -> h3_prime;
    h2 -> h4_prime;
    h2 -> h5_prime [color="#89E141", penwidth=2.0];

    h3 -> h1_prime;
    h3 -> h2_prime;
    h3 -> h3_prime;
    h3 -> h4_prime;
    h3 -> h5_prime [color="#89E141", penwidth=2.0];

    h4 -> h1_prime;
    h4 -> h2_prime;
    h4 -> h3_prime;
    h4 -> h4_prime;
    h4 -> h5_prime [color="#89E141", penwidth=2.0];

    h5 -> h1_prime;
    h5 -> h2_prime;
    h5 -> h3_prime;
    h5 -> h4_prime;
    h5 -> h5_prime [color="#89E141", penwidth=2.0];

    h6 -> h1_prime;
    h6 -> h2_prime;
    h6 -> h3_prime;
    h6 -> h4_prime;
    h6 -> h5_prime [color="#89E141", penwidth=2.0];
...
<div class="highlight-box" style="background-color: rgba(0, 0, 255, 0.3); border: 2px solid rgba(0, 0, 255, 0.3) ; top: 40px; left: 615px; width: 72px; height: 45px;"></div>
</div>
...
ReLU\left( \begin{bmatrix} w_{0,0} & \cdots & w_{0,n} \\ \vdots & \ddots & \vdots \\ w_{k,0} & \cdots & w_{k,n} \end{bmatrix} \begin{bmatrix} h_0^0 \\ \vdots \\ h_n^0 \end{bmatrix} + \begin{bmatrix} b_0^1 \\ \vdots \\ b_k^1 \end{bmatrix} \right) = \begin{bmatrix} h_0^1 \\ \vdots \\ h_k^1 \end{bmatrix}
$$
<div class="highlight-box" style="background-color: rgba(137, 225, 65, 0.3); border: 2px solid rgba(137, 225, 65, 0.3); top: 90px; left: 110px; width: 275px; height: 60px;"></div>
<div class="highlight-box" style="background-color: rgba(173, 216, 230, 0.3); border: 2px solid  rgba(173, 216, 230, 0.3); top: 40px; left: 405px; width: 71px; height: 165px;"></div>
<div class="highlight-box" style="background-color: rgba(213, 24, 24, 0.3); border: 2px solid rgba(213, 24, 24, 0.3); top: 95px; left: 500px; width: 71px; height: 45px;"></div>
<div class="highlight-box" style="background-color: rgba(0, 0, 255, 0.3); border: 2px solid rgba(0, 0, 255, 0.3) ; top: 95px; left: 615px; width: 72px; height: 45px;"></div>
</div>
...
ReLU\left( \begin{bmatrix} w_{0,0} & \cdots & w_{0,n} \\ \vdots & \ddots & \vdots \\ w_{k,0} & \cdots & w_{k,n} \end{bmatrix} \begin{bmatrix} h_0^0 \\ \vdots \\ h_n^0 \end{bmatrix} + \begin{bmatrix} b_0^1 \\ \vdots \\ b_k^1 \end{bmatrix} \right) = \begin{bmatrix} h_0^1 \\ \vdots \\ h_k^1 \end{bmatrix}
$$
<div class="highlight-box" style="background-color: rgba(137, 225, 65, 0.3); border: 2px solid rgba(137, 225, 65, 0.3); top: 150px; left: 110px; width: 275px; height: 60px;"></div>
<div class="highlight-box" style="background-color: rgba(173, 216, 230, 0.3); border: 2px solid  rgba(173, 216, 230, 0.3); top: 40px; left: 405px; width: 71px; height: 165px;"></div>
<div class="highlight-box" style="background-color: rgba(213, 24, 24, 0.3); border: 2px solid rgba(213, 24, 24, 0.3); top: 157px; left: 500px; width: 71px; height: 45px;"></div>
<div class="highlight-box" style="background-color: rgba(0, 0, 255, 0.3); border: 2px solid rgba(0, 0, 255, 0.3) ; top: 157px; left: 615px; width: 72px; height: 45px;"></div>
</div>
