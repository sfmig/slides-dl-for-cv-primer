...
- Minimum one layer between the first and the last layer
...
<div style="position: absolute; bottom: 120px; right: 80px; font-size: 0.3em; color: var(--link-color);">Figure from <a href="https://cs231n.github.io/neural-networks-1/" target="_blank">
...
Also known as **fully‐connected** or **feed-forward** networks
</div>
:::
...
The first layer in our neural network will hold these values, stretched out in 784 
different neurons (we reshape the 2D array as a vector)
